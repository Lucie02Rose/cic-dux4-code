...
#BSUB -J hifi-revio
#BSUB -G team274
#BSUB -o /lustre/scratch126/cellgen/behjati/lr26/outputs/%J-hifi-revio-alignemnt.out
#BSUB -e /lustre/scratch126/cellgen/behjati/lr26/errors/%J-hifi-revio-alignment.err
...
for sample in "${samples[@]}"; do
    base_dir="/lustre/scratch126/cellgen/behjati/lr26/PacBio-revio"
    output_dir="$base_dir"
