...
BAM_FILE="/lustre/scratch126/casm/team274sb/lr26/PacBio-aligned-hg38/mom_1B02_hifi_reads.bam"
REFERENCE="/lustre/scratch126/casm/team274sb/lr26/hg38/hg38.fa"
OUTPUT_DIR="/lustre/scratch126/casm/team274sb/lr26/PacBio-deepvariant-mom-hg38"
...
singularity exec --bind /lustre/scratch126/casm/team274sb/lr26:/mnt \
    ...
    -b "/mnt/PacBio-aligned-hg38/mom_1B02_hifi_reads.bam" \
    -f "/mnt/hg38/hg38.fa" \
    -o "/mnt/PacBio-deepvariant-mom-hg38" \
    -p "mom_output" \
    -t 32 \
    --hifi
