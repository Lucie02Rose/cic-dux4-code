...
#BSUB -J pepper-tumor
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/output_logs/vepsomatic38%J.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/error_logs/vepsomatic38%J.err
...
vep -i "$input_vcf" \
    -o "$output_dir/tumor_somatic_cosmic_clinvar_dbsnp.vcf" \
    --fasta "$reference" \
    --gff "$gff" \
