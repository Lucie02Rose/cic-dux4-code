...
#BSUB -J pepper
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/output_logs/pepperphased.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/error_logs/pepperphased.err
...
OUTPUT_DIR="/lustre/scratch126/casm/team274sb/lr26/pepper-blood-phased-t2t"
...
singularity exec --bind /lustre/scratch126/casm/team274sb/lr26:/mnt \
    ...
    -o "/mnt/pepper-blood-phased-t2t" \
    -p "blood_output_phasedt2t" \
    -t 32 \
    --hifi
