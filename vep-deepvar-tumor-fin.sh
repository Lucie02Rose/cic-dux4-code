...
#BSUB -J pepper-tumor
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/output_logs/peppertumor.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/error_logs/peppertumor.err
...
input_vcf="/lustre/scratch126/casm/team274sb/lr26/pepper-tumor1B01/tumor_output.vcf.gz"
...
vep \
  ...
  --output_file "$output_dir/tumor_vep_annotated_with_clinvar_and_dbsnp_vcf_new.vcf" \
  --vcf \
  --force_overwrite
