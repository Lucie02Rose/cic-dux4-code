...
#BSUB -J pepper-tumor
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/output_logs/veptumor.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/error_logs/veptumor.err
...
input_vcf="/lustre/scratch126/casm/team274sb/lr26/pepper-tumor38/tumor_output.vcf.gz"
...
vep -i "$input_vcf" \
    -o "$output_dir/tumor_vep_annotated_cosmic_clinvar_dbsnp.vcf" \
    --fasta "$reference" \
    --gff "$gff" \
