...
#BSUB -J blat-chr10
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/outputs/%J-chr10blat.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/errors/%J-chr10blat.err

### this is an optional script for the BLAT seach of the breakpoints of interest around the chr10 region ###
...
### therefore, define the bam file and region of interest (here it is start, end = 952000, 983400 in the Python script)
...
FASTA_DIR="/lustre/scratch126/casm/team274sb/lr26/pbmm2-alignment-tumor-new/fasta-chr10/"
### top 5 blat hits per soft clipped read ###
OUTPUT_FILE="/lustre/scratch126/casm/team274sb/lr26/pbmm2-alignment-tumor-new/blat_top5-chr10-parallel.csv"
