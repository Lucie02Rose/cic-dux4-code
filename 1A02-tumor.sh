...
#BSUB -J 1A02
#BSUB -G team274
#BSUB -o /lustre/scratch126/cellgen/behjati/lr26/outputs/%J-1A02.out
#BSUB -e /lustre/scratch126/cellgen/behjati/lr26/errors/%J-1A02.err
...
output_dir="/lustre/scratch126/cellgen/behjati/lr26/PacBio-aligned/1A02"
