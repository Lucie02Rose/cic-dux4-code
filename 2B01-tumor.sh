...
input_bam="/lustre/scratch126/cellgen/behjati/lr26/PacBio/tumor_2B01_hifi_reads.bam"
output_dir="/lustre/scratch126/cellgen/behjati/lr26/PacBio-aligned/2B01"
