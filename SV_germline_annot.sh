#!/bin/bash
#BSUB -o /lustre/scratch125/cellgen/behjati/lr26/outputs/%J-svfilt.o
#BSUB -e /lustre/scratch125/cellgen/behjati/lr26/errors/%J-svfilt.e
#BSUB -n 12
#BSUB -M 32000
...
bed="/lustre/scratch125/cellgen/behjati/lr26/T2T/chm13v2.0_RefSeq_Liftoff_v5.2.bed"
...
sawfish="/lustre/scratch125/cellgen/behjati/lr26/SV/PacBio-sawfish-somatic-new/tumor_all_genotyped.norm.sv.vcf.gz"
sawfish_annot="/lustre/scratch125/cellgen/behjati/lr26/SV/PacBio-sawfish-somatic-new/tumor_all_genotyped.annot.norm.sv.vcf.gz"
...
repeats="/lustre/scratch125/cellgen/behjati/lr26/T2T/chm13v2.0_RepeatMasker_4.1.2p1.2022Apr14.bed"
