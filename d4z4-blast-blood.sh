...
#BSUB -J blast
#BSUB -G team274
#BSUB -o /lustre/scratch126/cellgen/behjati/lr26/outputs/%J-blast-blood.out
#BSUB -e /lustre/scratch126/cellgen/behjati/lr26/errors/%J-blast-blood.err
set -euo pipefail
...
# === Configurable paths ===
QUERY="/lustre/scratch126/cellgen/behjati/lr26/T2T/d4z4.fasta"  # D4Z4 consensus
TARGET_CONTIGS="/nfs/team274/lr26/PacBio-blood/PacBio-blood.bp.p_ctg.fasta"  # Patient's contigs
CONTIG_BAM="/nfs/team274/lr26/PacBio-blood/PacBio-blood.bp.p_ctg_vs_t2t.bam"  # BAM of contigs aligned to T2T

DB_PREFIX="blood_genome_db"
THREADS=8
PIDENTITY_THRESHOLD=80
QCOV_THRESHOLD=85

# === Output files ===
BLAST_OUTPUT="d4z4_matches_blood.tsv"
FILTERED_HITS="d4z4_confident_blood.tsv"
REGIONS_BED="d4z4_regions_blood.txt"
EXTRACTED_FASTA="extracted_d4z4s_blood.fasta"
D4Z4_DB="d4z4_sequences_blood_db"
ALL_VS_ALL_OUT="d4z4_sequences_all_vs_all_blood.tsv"
MAPPED_COORDS="d4z4_blood_regions_mapped.tsv"
