...
input_bam="/lustre/scratch126/casm/team274sb/lr26/pbmm2-alignment-tumor-new/tumor-all_pbmm2-farm22.bam"
output_dir="/lustre/scratch126/casm/team274sb/lr26/severus-tumor-all"

# Create output directory if it does not exist
mkdir -p "$output_dir"

# Process each BAM file in the directory
for input_bam in "$input_bam"; do
