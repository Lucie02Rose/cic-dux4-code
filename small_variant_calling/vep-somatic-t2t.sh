...
#BSUB -J pepper-tumor
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/output_logs/vepsomatic.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/error_logs/vepsomatic.err
...
input_vcf="/lustre/scratch126/casm/team274sb/lr26/pepper-tumor1B01/tumor_somatic.vcf.gz"
...
vep \
  ...
  --output_file "$output_dir/tumor_somatic_annotated_clinvar_dbsnp.vcf" \
  --vcf \
  --force_overwrite
