...
#BSUB -J pepper-blood
#BSUB -G team274
#BSUB -o /lustre/scratch126/casm/team274sb/lr26/output_logs/vepgrmline38.out
#BSUB -e /lustre/scratch126/casm/team274sb/lr26/error_logs/vepgermline38.err
...
input_vcf="/lustre/scratch126/casm/team274sb/lr26/pepper-tumor38/blood_mom_somatic_hg38.vcf.gz"
...
vep -i "$input_vcf" \
    -o "$output_dir/germline38_vep_annotated_clinvar_dbsnp.vcf" \
    --fasta "$reference" \
    --gff "$gff" \
